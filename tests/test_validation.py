...
def test_validate_angles_three() -> None:
    """Accept three compatible view angles."""
    assert validate_angles(["top", "left", "front"]) == ["top", "left", "front"]
...
def test_validate_angles_too_many() -> None:
    """Reject more than three angles."""
    with pytest.raises(ValueError):
        validate_angles(["top", "left", "front", "back"])
